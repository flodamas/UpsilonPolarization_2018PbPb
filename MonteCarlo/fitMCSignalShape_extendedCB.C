...
void fitMCSignalShape_extendedCB(Int_t minPt = 0, Int_t maxPt = 30, Int_t centMin = 0, Int_t centMax = 90) {
	...
	canvas->SaveAs(Form("Figures/extendedCB_cent%dto%d_pt%dto%dGeV.png", centMin, centMax, minPt, maxPt), "RECREATE");
}
