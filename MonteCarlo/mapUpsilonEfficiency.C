	...
	for (Long64_t iEvent = 0; iEvent < totEntries; iEvent++) {
		...
		for (int iGen = 0; iGen < Gen_QQ_size; iGen++) {
			...
			if (isRecoMatched) {
				...
				hCS_muId_systUp->FillWeighted(allGood, totalWeight, muplPvecBoostedCS.CosTheta(), muplPvecBoostedCS.Phi() * 180 / TMath::Pi());
				hHX_muId_systUp->FillWeighted(allGood, totalWeight, muplPvecBoosted.CosTheta(), muplPvecBoosted.Phi() * 180 / TMath::Pi());
				...
				hCS_muId_systDown->FillWeighted(allGood, totalWeight, muplPvecBoostedCS.CosTheta(), muplPvecBoostedCS.Phi() * 180 / TMath::Pi());
				hHX_muId_systDown->FillWeighted(allGood, totalWeight, muplPvecBoosted.CosTheta(), muplPvecBoosted.Phi() * 180 / TMath::Pi());
				...
				hCS_muId_statUp->FillWeighted(allGood, totalWeight, muplPvecBoostedCS.CosTheta(), muplPvecBoostedCS.Phi() * 180 / TMath::Pi());
				hHX_muId_statUp->FillWeighted(allGood, totalWeight, muplPvecBoosted.CosTheta(), muplPvecBoosted.Phi() * 180 / TMath::Pi());
				...
				hCS_muId_statDown->FillWeighted(allGood, totalWeight, muplPvecBoostedCS.CosTheta(), muplPvecBoostedCS.Phi() * 180 / TMath::Pi());
				hHX_muId_statDown->FillWeighted(allGood, totalWeight, muplPvecBoosted.CosTheta(), muplPvecBoosted.Phi() * 180 / TMath::Pi());
				...
				hCS_trig_systUp->FillWeighted(allGood, totalWeight, muplPvecBoostedCS.CosTheta(), muplPvecBoostedCS.Phi() * 180 / TMath::Pi());
				hHX_trig_systUp->FillWeighted(allGood, totalWeight, muplPvecBoosted.CosTheta(), muplPvecBoosted.Phi() * 180 / TMath::Pi());
				...
				hCS_trig_systDown->FillWeighted(allGood, totalWeight, muplPvecBoostedCS.CosTheta(), muplPvecBoostedCS.Phi() * 180 / TMath::Pi());
				hHX_trig_systDown->FillWeighted(allGood, totalWeight, muplPvecBoosted.CosTheta(), muplPvecBoosted.Phi() * 180 / TMath::Pi());
				...
				hCS_trig_statUp->FillWeighted(allGood, totalWeight, muplPvecBoostedCS.CosTheta(), muplPvecBoostedCS.Phi() * 180 / TMath::Pi());
				hHX_trig_statUp->FillWeighted(allGood, totalWeight, muplPvecBoosted.CosTheta(), muplPvecBoosted.Phi() * 180 / TMath::Pi());
				...
				hCS_trig_statDown->FillWeighted(allGood, totalWeight, muplPvecBoostedCS.CosTheta(), muplPvecBoostedCS.Phi() * 180 / TMath::Pi());
				hHX_trig_statDown->FillWeighted(allGood, totalWeight, muplPvecBoosted.CosTheta(), muplPvecBoosted.Phi() * 180 / TMath::Pi());
			}
