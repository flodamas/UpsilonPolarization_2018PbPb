...
double tnp_weight_muid_pbpb(double pt, double eta, int idx, double *num, double *den) {
	double x = pt;
	// double *num = 1, *den = 1, syst = 0, statUp = 0, statDown = 0;
	double syst = 0, statUp = 0, statDown = 0;
	if (idx != 99) {
		// SF for 0 < |eta| < 1.2
...
double tnp_weight_trg_pbpb_mc(double pt, double eta, int filterId, int idx, double *num, double *den) {
	double x = pt;
	// double num = 1, den = 1, syst = 0, statUp = 0, statDown = 0;
	double syst = 0, statUp = 0, statDown = 0;
...
double tnp_weight_trg_pbpb(double pt, double eta, int filterId, int idx, double* num, double* den) {
	double x = pt;
	// double num = 1, den = 1, syst = 0, statUp = 0, statDown = 0;
	double syst = 0, statUp = 0, statDown = 0;
	if (filterId == 0) { //L2 Jpsi
...
double tnp_weight_trk_pbpb(double eta, int idx, double *num, double *den) {
	double x = eta;
	// double num = 1, den = 1, syst = 0, statUp = 0, statDown = 0;
	double syst = 0, statUp = 0, statDown = 0;
	if (idx != 99) {
